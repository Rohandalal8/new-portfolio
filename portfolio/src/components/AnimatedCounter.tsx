        ...
        <div id="counter" ref={counterRef} className="padding-x-sm my-22">
            <div className="grid-4-cols ">
                {counterItems.map((item) => (
                    <div className="counter-item group rounded-lg p-10 flex flex-col justify-center bg-[#6366f1]/10 shadow-[15px_15px_30px_rgb(25,25,25,0.1),_-15px_-15px_30px_rgb(60,60,60,0.1)]">
